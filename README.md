...
This guide instructs Marvin McLaren, a Finance Manager at Foomatic Corp, on how to create, format, and host a professional resume website using modern technical writing tools. By following these instructions, you will learn to apply principles from Andrew Etter’s *Modern Technical Writing*, specifically the use of lightweight markup languages, distributed version control, and static site generators. This guide assumes basic command line knowledge but no prior experience with these tools.
...
## Further Resources
1.  **[Markdown Guide - Basic Syntax](https://www.markdownguide.org/basic-syntax/)**: A comprehensive, third-party tutorial on Markdown syntax.
...
*   **Author:** Marvin McLaren (Student ID: 1234567)
*   **Peer Review Group:** Alice Johnson, Bob Smith, Charlie Brown.
*   **Software Used:** Pelican (by Alexis Métaireau), NotMyIdea Theme.
*   **References:**
